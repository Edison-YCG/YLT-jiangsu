jQuery.easing = {
  ...
  bounceinout: function (x, t, b, c, d) {
    ...
    return (
      jQuery.easing["bounceout"](x, t * 2 - d, 0, c, d) * 0.5 + c * 0.5 + b
    );
  },
...
(function ($) {
  $.fn.lavaLamp = function (o) {
    ...
    return this.each(function () {
      var b = $(this),
        noop = function () {},
        $back = $('<div class="wetrial-menu-back">&nbsp;</div>').appendTo(b),
        $li = $("li", this),
        curr =
          $("li.wetrial-menu-current", this)[0] ||
          $($li[0]).addClass("wetrial-menu-current")[0];
      $li.not(".wetrial-menu-back").hover(function () {
        move(this);
      }, noop);
      ...
      function removeActive(a) {
        $li.children("a").not(".wetrial-menu-back").removeClass("on");
        $(a).children("a").addClass("on");
      }
    });
  };
